        ...
        echo "<div class='row ml-3 my-2 w-100' id='".$topicTitle."Row'>";
          echo "<div class='input-group pr-1'>";
            ...
            echo "<div class='input-group-append'>";
              ...
              echo "<button class='btn btn-sm btn-danger' id='".$topicTitle."DeleteButton' onclick='return deleteTopic(".$topic['id'].", \"".$topicTitle."\", ".$root.");' data-toggle='tooltip' data-placement='top' title='Delete This Topic'><i class='fas fa-trash-alt'></i></button>";
      ...
      echo "<div class='row ml-3 my-2' id='module".$moduleCount."'>";
        echo "<div class='input-group pr-1'>";
          ...
          echo "<div class='input-group-append'>";
            ...
            echo "<button class='btn btn-sm btn-danger' id='".$moduleTitle."DeleteButton' onclick='return deleteModule(".$module['id'].",\"".$moduleTitle."\", ".$moduleCount.");' data-toggle='tooltip' data-placement='top' title='Delete this Module'><i class='fas fa-trash-alt'></i></button>";
          echo "</div>";
        echo "</div>"; // Close input group
      echo "</div>"; // Close module row Div
