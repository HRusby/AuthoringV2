<?php
// DONE
// Post Values: mID, tTitle, tDesc, tags, prereqs, optional
    session_start();
    ini_set("default_charset", 'utf-8');
    $userid = $_SESSION['user_id'];
    $moduleID = $_POST['mID'];
    $title = htmlspecialchars($_POST['tTitle']);
...
// Update tags and frequency DONE
// Input new tpl_post record DONE
// Input new tpl_topic_tutorial record DONE
?>
